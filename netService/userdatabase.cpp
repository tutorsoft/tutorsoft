...
userDataBasePri::userDataBasePri()
{
    ...
    ret = query.exec(QString::fromLocal8Bit("create table need_information(needid varchar(50) primary key,need_name varchar(50),course varchar(50),start_time varchar(50),stop_time varchar(50),cost varchar(50),needgrade varchar(50),needstr varchar(200),issuer varchar(50),acceptissuer varchar(50))"));
