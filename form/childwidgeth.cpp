...
#include "childwidgeth.h"
#include "ui_childwidgeth.h"
...
ChildWidgetH::ChildWidgetH(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::ChildWidgetH)
{
    ui->setupUi(this);
    MainWidget::allSignalEvent.setChildWidgetH(this);
    selectrow = 0;
    QStringList header;
...
ChildWidgetH::~ChildWidgetH()
{
    delete ui;
}

void ChildWidgetH::showEvent(QShowEvent *event)
{
    QString tstr0 = "need_information";
    QString strsend =  "ChildWidgetH_queryAll:" + tstr0;
    emit sendWriteSocket(strsend);
}

void ChildWidgetH::onHeaderClicked(int row,int column)
{
    selectrow = row;
}

void ChildWidgetH::on_btn_look_clicked()
{
    ...
    QString strsend =  "ChildWidgetH:" + updataStr;
    emit sendWriteSocket(strsend);

}

void ChildWidgetH::acceptSocketData(QString ret)
{
    qDebug()<<"ChildWidgetH==>"<<ret;
