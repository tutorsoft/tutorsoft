...
#include "childwidgetj.h"
#include "ui_childwidgetj.h"
...
ChildWidgetJ::ChildWidgetJ(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::ChildWidgetJ)
{
    ui->setupUi(this);
    MainWidget::allSignalEvent.setChildWidgetJ(this);
    selectrow = 0;
    QStringList header;
...
ChildWidgetJ::~ChildWidgetJ()
{
    delete ui;
}

void ChildWidgetJ::showEvent(QShowEvent *event)
{
    QString tstr0 = "need_information";
    QString strsend =  "ChildWidgetJ_queryAll:" + tstr0;
    emit sendWriteSocket(strsend);
}

void ChildWidgetJ::onHeaderClicked(int row,int column)
{
    selectrow = row;
}

void ChildWidgetJ::on_btn_look_clicked()
{
    ...
    QString strsend =  "ChildWidgetJ:" + updataStr;
    emit sendWriteSocket(strsend);

}

void ChildWidgetJ::acceptSocketData(QString ret)
{
