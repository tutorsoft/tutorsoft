...
void ScreenWidget::initForm()
{
	...
	menu->addAction("saved as", this, SLOT(saveScreenOther()));
	menu->addAction("full screen", this, SLOT(saveFullScreen()));
	menu->addAction("close", this, SLOT(hide()));
...
void ScreenWidget::paintEvent(QPaintEvent *)
{
	...
	painter.setPen(pen);
	painter.drawText(x + 2, y - 8, tr("range( %1 x %2 ) - ( %3 x %4 )  size ( %5 x %6 )")
...
{
	QString fileName = QFileDialog::getSaveFileName(this, "save image", STRDATETIME, "JPEG Files (*.jpg)");
